package com.javahelps.apporderfoods.DAO;
...
//    Lay tat ca danh sach ban an DTO
    public List<BanAnDTO> LayTatCaBanAn(){
        List<BanAnDTO> banAnDTOList = new ArrayList<BanAnDTO>();    //Tao danh sach bananDTOlist
        String truyvan = "SELECT * FROM " + CreateDatabase.TB_BANAN;
        Cursor cursor = database.rawQuery(truyvan, null);
        cursor.moveToFirst();       //tro con tro toi vi tri dau tien cua du lieu truy van
